...
func RegisterForumRoutes(server *rest.Server, forum *ForumHandler) {
	server.AddRoutes([]rest.Route{
		...
		{Method: http.MethodGet, Path: "/api/v1/public/forum/topics", Handler: forum.TopicList},
		{Method: http.MethodGet, Path: "/api/v1/public/forum/topics/:id/detail", Handler: forum.TopicDetail},
		{Method: http.MethodGet, Path: "/api/v1/public/forum/users/:id/history-topics", Handler: forum.AuthorHistory},
	})
}
